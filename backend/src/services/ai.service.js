...
const interviewReportSchema = z.object({
    ...
    skillGaps: z.array(z.object({
        ...
        serverity: z.enum(["low", "medium", "high"]).describe("The severity of this skill gap, i.e. how important is this skill for the job and how much it can impact the candidate's chances")
...
async function generateInterviewReport({ resume, jobdescribe, selfdescribe }) {
...
async function generateResumePdf({ resume, selfDescription, jobDescription }) {
    ...
    const resumePdfSchema = z.object({
        html: z.string().describe("The HTML content for the resume PDF.")
    })
    ...
    return await generatePdfFormHtml(jsonContent.html)
